import keras
from keras.layers import Input, Dense, Conv3D, MaxPooling3D, UpSampling3D, Cropping3D,Dropout,Add,Reshape, concatenate
...
def FCN_ed2(img_shape, class_n=None):
    ...
    return model
# def FCN_BN(img_shape, class_n=None):
...
#     # block1
#     conv1_1 = conv_block(input_img, filters=32, kernel_size=3, batch_norm=False)
#     conv1_2 = conv_block(conv1_1, filters=32, kernel_size=3, batch_norm=False)
#     pool1 = MaxPooling3D((2, 2, 2), strides=(2, 2, 2),padding='same')(conv1_2)
#     # block2
#     conv2_1 = conv_block(pool1, filters=64, kernel_size=3, batch_norm=False)
#     conv2_2 = conv_block(conv2_1, filters=64, kernel_size=3, batch_norm=False)
#     pool2 = MaxPooling3D((2, 2, 2), strides=(2, 2, 2),padding='same')(conv2_2)
#     # block3
#     conv3_1 = conv_block(pool2, filters=128, kernel_size=3, batch_norm=False)
#     conv3_2 = conv_block(conv3_1, filters=128, kernel_size=3, batch_norm=False)
#     conv3_3 = conv_block(conv3_2, filters=128, kernel_size=3, batch_norm=False)
#     pool3 = MaxPooling3D((2, 2, 2), strides=(2, 2, 2),padding='same')(conv3_3)

#     # fully conv
#     fc4 = conv_block(pool3, filters=1024, kernel_size=3, batch_norm=False)
#     drop5 = Dropout(0.7)(fc4)

#     fc6 = conv_block(drop5, filters=1024, kernel_size=3, batch_norm=False)
#     drop7 = Dropout(0.7)(fc6)
...
# def conv_block(input, filters, kernel_size, batch_norm=False):
#     conv = Conv3D(filters, kernel_size, padding='same')(input)
